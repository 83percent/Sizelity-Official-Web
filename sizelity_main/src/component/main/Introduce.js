                ...
                <ul>
                    ...
                    <li onClick={(e) => faqToggle(e.target)}>
                        ...
                        <div className="answer">
                            ...
                            <p>다만, 사이즈리티와 쇼핑몰을 자동으로 연결하는 기능을 사용하기 위해서는 자사 쇼핑몰을 운영해야 해요.</p>
                            <p>자사 쇼핑몰이 아니더라도, 사이즈리티에서 제공하는 다양한 방식을 통해 고객에게 서비스를 제공할 수 있어요.</p>
                        </div>
                    </li>
                    <li onClick={(e) => faqToggle(e.target)}>
                        <div className="question">
                            <h3>"무료 체험" 같은 건 없나요?</h3>
                            <i className="material-icons">keyboard_arrow_down</i>
                        </div>
                        <div className="answer">
                            <p>사이즈리티는 쇼핑몰에 수익을 분배해주기에 "무료 체험"이라는 의미보다는 쇼핑몰에 수익이 발생할 수 있는 환경이 갖춰지는 기간을 한 달로 정했어요.</p>
                            <p>등록 후, 한 달 이후부터, 수익과 지출이 산정됩니다. 그전에는 0원이에요.</p>
                        </div>
                    </li>
                    <li onClick={(e) => faqToggle(e.target)}>
                        <div className="question">
